...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.navigation_frame_label = customtkinter.CTkLabel(self.navigation_frame, text="  Koceila Nabil", image=self.logo_image,
        ...
        self.home_frame_button_2 = customtkinter.CTkButton(
            self.home_frame, text="Creer une autre grille", image=self.add_grille_image, compound="right")
        self.home_frame_button_2.grid(row=2, column=0, padx=20, pady=10)

        self.select_map_menu = customtkinter.CTkOptionMenu(self.home_frame, values=["Grille de jeu n°1", "Grille de jeu n°2", "Grille de jeu n°3"],
                                                           command=lambda x: print(x))
        self.select_map_menu.grid(row=5, column=0, padx=20, pady=10)
        # create second frame
